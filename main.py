...
# Akeem McKenzie University of North Florida
...
def make_first_window():
    ...
    return sg.Window('University of North Florida CSV Comparison Tool', layoutprefile,)

#Function to make second window from layout
def make_second_window(layout):
